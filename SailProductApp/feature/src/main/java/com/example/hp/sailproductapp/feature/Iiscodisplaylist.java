...
public class Iiscodisplaylist extends AppCompatActivity {
    String jsondata;
    JSONObject jsonObject;
    JSONArray jsonArray;
    Iiscoadapter iiscoadapter;
    ListView iiscolist;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_iiscodisplaylist);
        iiscolist =(ListView)findViewById(R.id.iiscolist);

        iiscoadapter =new Iiscoadapter(this,R.layout.iisco_row);
        iiscolist.setAdapter(iiscoadapter);
        ...
        try {
            ...
            while (count<jsonArray.length()){
                ...
                Iiscocontents contents=new Iiscocontents(Category,Grade,C_Min,C_Max,S_Min,S_Max,P_Min,P_Max,SP_Max,Mn_Min,Mn_Max,Si_Min,Si_Max,Cr_Min,Cr_Max,V_Min,V_Max,Pb_Min,Pb_Max,Mo_Min,Mo_Max,Al_Min,Al_Max,B_Min,B_Max,Ti_Max,Cu_Min,Cu_Max,CE_Max,MAE,Ni_Min,Ni_Max,Nb_Max);
                iiscoadapter.add(contents);
                count++;
