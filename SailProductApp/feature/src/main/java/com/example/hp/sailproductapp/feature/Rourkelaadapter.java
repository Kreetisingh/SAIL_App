...
public class Rourkelaadapter extends ArrayAdapter {
    List list=new ArrayList();


    public Rourkelaadapter(@NonNull Context context, int resource) {
        super(context, resource);
    }

    public void add(Rourkelacontents object){
        super.add(object);
        list.add(object);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(row==null){
            ...
            row=layoutInflater.inflate(R.layout.rourkela_row,parent,false);
        ...
        Rourkelacontents contents=(Rourkelacontents) this.getItem(position);
