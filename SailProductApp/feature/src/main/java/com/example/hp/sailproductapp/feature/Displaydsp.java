...
public class Displaydsp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_displaydsp);
        listdsp=(ListView)findViewById(R.id.listdsp);

        dspadapter=new Dspadapter(this,R.layout.dsp_row);
        listdsp.setAdapter(dspadapter);
        ...
        try {
            ...
            while (count<jsonArray.length()){
                ...
                Dspcontents contents=new Dspcontents(Category,Grade,C_Min,C_Max,S_Min,S_Max,P_Min,P_Max,SP_Max,Mn_Min,Mn_Max,Si_Min,Si_Max,Cr_Min,Cr_Max,V_Min,V_Max,Pb_Min,Pb_Max,Mo_Min,Mo_Max,Al_Min,Al_Max,B_Min,B_Max,Ti_Max,Cu_Min,Cu_Max,CE_Max,MAE,Ni_Min,Ni_Max,Nb_Max);

                dspadapter.add(contents);
                count++;
