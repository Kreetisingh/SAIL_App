...
public class Bspdisplaylist extends AppCompatActivity {
    String jsondata;
    JSONObject jsonObject;
    JSONArray jsonArray;
    BspAdapter contactAdapter;
    ListView listbsp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listbsp=(ListView)findViewById(R.id.listbsp);

        contactAdapter=new BspAdapter(this,R.layout.row_layout);
        listbsp.setAdapter(contactAdapter);
        ...
        try {
            ...
            while (count<jsonArray.length()){
                ...
                Contentsbsp contents=new Contentsbsp(Category,Grade,C_Min,C_Max,S_Min,S_Max,P_Min,P_Max,SP_Max,Mn_Min,Mn_Max,Si_Min,Si_Max,Cr_Min,Cr_Max,V_Min,V_Max,Pb_Min,Pb_Max,Mo_Min,Mo_Max,Al_Min,Al_Max,B_Min,B_Max,Ti_Max,Cu_Min,Cu_Max,CE_Max,MAE,Ni_Min,Ni_Max,Nb_Max);
                contactAdapter.add(contents);
                count++;
