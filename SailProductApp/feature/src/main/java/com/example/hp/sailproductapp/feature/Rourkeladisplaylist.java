...
public class Rourkeladisplaylist extends AppCompatActivity {
    String jsondata;
    JSONObject jsonObject;
    JSONArray jsonArray;
    Rourkelaadapter rourkelaadapter;
    ListView rourkelalist;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rourkeladisplaylist);
        rourkelalist =(ListView)findViewById(R.id.rourkelalist);

        rourkelaadapter =new Rourkelaadapter(this,R.layout.rourkela_row);
        rourkelalist.setAdapter(rourkelaadapter);
        ...
        try {
            ...
            while (count<jsonArray.length()){
                ...
                Rourkelacontents contents=new Rourkelacontents(Category,Grade,C_Min,C_Max,S_Min,S_Max,P_Min,P_Max,SP_Max,Mn_Min,Mn_Max,Si_Min,Si_Max,Cr_Min,Cr_Max,V_Min,V_Max,Pb_Min,Pb_Max,Mo_Min,Mo_Max,Al_Min,Al_Max,B_Min,B_Max,Ti_Max,Cu_Min,Cu_Max,CE_Max,MAE,Ni_Min,Ni_Max,Nb_Max);
                rourkelaadapter.add(contents);
                count++;
