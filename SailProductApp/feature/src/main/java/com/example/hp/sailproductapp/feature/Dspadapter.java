...
public class Dspadapter extends ArrayAdapter {
    List list=new ArrayList();


    public Dspadapter(@NonNull Context context, int resource) {
        super(context, resource);
    }

    public void add(Dspcontents object){
        super.add(object);
        list.add(object);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(row==null){
            ...
            row=layoutInflater.inflate(R.layout.dsp_row,parent,false);
        ...
        Dspcontents contents=(Dspcontents) this.getItem(position);
