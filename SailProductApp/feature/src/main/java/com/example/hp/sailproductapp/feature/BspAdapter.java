...
public class BspAdapter extends ArrayAdapter {
    List list=new ArrayList();


    public BspAdapter(@NonNull Context context, int resource) {
        super(context, resource);
    }

    public void add(Contentsbsp object){
        super.add(object);
        list.add(object);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Contentsbsp contents=(Contentsbsp)this.getItem(position);
