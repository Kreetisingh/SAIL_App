...
public class Bokaroadapter extends ArrayAdapter {
    List list = new ArrayList();

    public Bokaroadapter(@NonNull Context context, int resource) {

     super(context, resource);

    }

    public void add(Bokarocontents object) {
        super.add(object);
        list.add(object);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row = layoutInflater.inflate(R.layout.bokaro_row, parent, false);
        ...
        Bokarocontents contents = (Bokarocontents) this.getItem(position);
